...
* File a ticket on [GitHub](https://github.com/purbon/monitoring-kafka-with-prometheus/issues). 

## Something Not Working? Found a Bug? or a Security Issue?

If you think you found a bug, it probably is a bug.

* File it in [Kafka Health API GitHub](https://github.com/purbon/monitoring-kafka-with-prometheus/issues)
...
You can reach us via [GitHub](https://github.com/purbon/monitoring-kafka-with-prometheus/issues).
...
See: https://github.com/purbon/monitoring-kafka-with-prometheus/labels/adoptme
https://github.com/purbon/monitoring-kafka-with-prometheus/labels/low%20hanging%20fruit
...
1. Test your changes! [Run](https://github.com/purbon/monitoring-kafka-with-prometheus#testing) the test suite
